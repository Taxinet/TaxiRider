...

{
    ...
    [manager POST:url parameters:param
          success:^(AFHTTPRequestOperation *operation, id responseObject) {
              ...
              owner.promotionDataArr = promotionData.promotionDataArr;
              
             // NSLog(@"PROMOTION DATA:%@", owner.promotionDataArr);
              //[owner.promotionDataArr ]
              ///
              //NSLog(@"Driver firstname:");
              [owner checkAndSetData];
          }
          failure:^(AFHTTPRequestOperation *operation, NSError *error) {
              NSLog(@"Request promotion trip Error: %@",error);
          }];
